...
def compute_metrics(eval_pred):
    ...
    if num_labels == 1: # This part is for regression and is fine
    ...
    else: # This part is for classification and needs to be changed
        ...
        # For AUROC, scikit-learn needs the probabilities of the positive class only
        positive_class_probs = probs[:, 1]
        
        f1 = f1_score(labels, predictions, average="macro")
        # Use the 1D array of positive probabilities for auroc
